    ...
    <SafeAreaView className="bg-primary h-full">
      <ScrollView contentContainerStyle={{ height: "100%" }}>
        <View className="w-full justify-center items-center h-full px-4">
          ...
          <Text className="text-center text-sm font-regular text-gray-100 mt-7">Where Creativity meets innovation: embark on a journey of limmitless exploration with Aora</Text>
          <CoustomButton
